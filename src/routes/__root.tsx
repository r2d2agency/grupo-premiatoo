...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Garantidora Premiatto" },
      { name: "description", content: "Garantidora Premiatto – estrutura, capital e segurança para operações que exigem critério e continuidade." },
      { name: "author", content: "Garantidora Premiatto" },
      { property: "og:title", content: "Garantidora Premiatto" },
      { property: "og:description", content: "Garantias e soluções financeiras institucionais." },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600&family=Inter:wght@400;500;600;700&family=Playfair+Display:ital,wght@0,400;0,700;1,400&display=swap",
      },
      { rel: "stylesheet", href: appCss },
      {
        rel: "icon",
        type: "image/svg+xml",
        href: "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 48 48'><rect width='48' height='48' rx='8' fill='%230B1F3A'/><polygon points='24,6 40,15 40,33 24,42 8,33 8,15' fill='none' stroke='%23ffffff' stroke-width='2'/><polygon points='24,14 34,24 24,34 14,24' fill='none' stroke='%23ffffff' stroke-width='1.6'/><circle cx='24' cy='24' r='2' fill='%23ffffff'/></svg>",
      },
    ],
  }),
