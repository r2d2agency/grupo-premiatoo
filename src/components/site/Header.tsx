      ...
      <div className="mx-auto max-w-[1280px] px-6 flex items-center justify-between gap-6">
        ...
        <nav className="hidden lg:flex items-center gap-7 text-[13px]">
          {navLinks.map((n) => (
            ...
            >
              <Link 
                to={n.label === "Notícias" || n.label === "Conteúdos" ? "/news" : n.label === "Garantias" ? "/garantias" : n.label === "Governança" ? "/governanca" : n.label === "Crédito de Carbono" ? "/carbono" : (n.href === "/institucional" || n.label === "Institucional" ? "/institucional" : (n.href.startsWith("#") ? "/" : n.href))} 
