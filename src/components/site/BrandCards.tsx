        ...
        {cards.map((c, i) => {
          ...
          return (
            <div
              key={i}
              className={
                "relative overflow-hidden rounded-sm p-8 min-h-[280px] flex flex-col justify-between transition-transform hover:scale-[1.02] " +
                (dark ? "bg-navy text-navy-foreground" : "bg-white text-navy shadow-md")
              }
            >
              ...
              <div className="relative">
                {c.logoUrl ? (
                  <img src={c.logoUrl} alt="Logo" className="h-10 w-auto object-contain mb-4" />
                ) : (
                  dark ? (
